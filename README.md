...
📉 Меньшее значение метрики для помидоров (по сравнению с огурцами) скорее всего связано с тем, что некоторые болезни для помидоров более схожи между собой, и их для модели сложнее разделить. Вдобавок датасет для огурцов состоит из более качественных фотографий (благодаря датасету CDRD) по сравнению с датасетом для томатов.
